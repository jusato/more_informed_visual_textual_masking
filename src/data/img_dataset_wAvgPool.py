...
def load_images(sentence_ids, feat_path, img_names, n_regions):
    ...
    for idx in sentence_ids:
        ...
        with open(f_name, "rb") as f:
            ...
            # x['num_detections'] = min(int(output['num_detections']), num_proposals)
            # print('x[num_detections] =', x['num_detections'])
            # print('x[detection_features] =', x['detection_features'])
            # print('x[detection_features][:n_regions] =', x['detection_features'][:n_regions])
            # print('x[detection_features][:n_regions].squeeze() =', x['detection_features'][:n_regions].squeeze())
